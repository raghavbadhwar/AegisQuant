...
SCHEMAS: dict[str, Any] = {
    ...
    "release-evidence-reference-v1": ReleaseEvidenceReference,
    ...
    "risk-trust-store-v1": RiskTrustStore,
    ...
    "trusted-risk-key-record-v1": TrustedRiskKeyRecord,
    ...
    "venue-order-lifecycle-evidence-v1": VenueOrderLifecycleEvidence,
    "venue-risk-authorization-v1": VenueRiskAuthorization,
    "venue-risk-context-v1": VenueRiskContext,
